...
SELECT C.NOME, C.EMAIL, C.SEXO, T.TIPO, T.NUMERO, E.BAIRRO, E.CIDADE, E.ESTADO
FROM CLIENTE C
INNER JOIN TELEFONE T
	ON C.IDCLIENTE = T.ID_CLIENTE
INNER JOIN ENDERECO E
...
SELECT C.NOME, IFNULL(C.EMAIL,'Cliente sem Email') as EMAIL, C.SEXO, T.TIPO, T.NUMERO, E.BAIRRO, E.CIDADE, E.ESTADO
FROM CLIENTE C
INNER JOIN TELEFONE T
	ON C.IDCLIENTE = T.ID_CLIENTE
INNER JOIN ENDERECO E
